package com.demo.news.agregator.demo.views.y_combinator;
...
@PageTitle("You Combinator")
@Route(value = "y-combinator", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@AnonymousAllowed
public class YCombinatorView extends Div implements AfterNavigationObserver {
    @Autowired
    ...
    private List<NewsDTO> fetchData() {
        ...
        return newsService.getAllNewsBySource(NewsSourceEnum.YOU_COMBINATOR)
                .stream()
                .skip(offset)
                .limit(itemsPerPage)
